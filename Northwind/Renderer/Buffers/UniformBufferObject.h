...
class UniformBufferObject : public BaseBufferObject
{
public:
    UniformBufferObject();
    ~UniformBufferObject();
    ...
    void ReferenceTo(const UniformBufferObject& _other);
    void ReferenceTo(const UniformBufferObject& _other, size _refOffset, size _refSize);
