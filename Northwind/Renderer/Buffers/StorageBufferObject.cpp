...
bool StorageBufferObject::Alloc(const VkDevice& _device, const void* _data, size _allocSize, EBufferUsage _usage)
{
...
void StorageBufferObject::ReferenceTo(const StorageBufferObject& _other)
{
...
void StorageBufferObject::ReferenceTo(const StorageBufferObject& _other, size _refOffset, size _refSize)
{
    nwAssertReturnVoid(!IsMapped(), "Buffer must be not mapped");
...
void StorageBufferObject::Update(const void* _data, size _size, size _offset /*= 0*/) const
{
...
void* StorageBufferObject::MapBuffer(EBufferMappingType _mapType)
{
    return MapBuffer(_mapType, 0);
}

void* StorageBufferObject::MapBuffer(EBufferMappingType _mapType, size _offset)
{
...
void StorageBufferObject::UnmapBuffer()
{
    nwAssertReturnVoid(m_object != VK_NULL_HANDLE, "Buffer must be allocated");
...
void StorageBufferObject::ClearWithoutFreeing()
{
    m_size = 0;
