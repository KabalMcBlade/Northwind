...
bool IndexBufferObject::Alloc(const VkDevice& _device, const void* _data, size _allocSize, EBufferUsage _usage)
{
...
void IndexBufferObject::ReferenceTo(const IndexBufferObject& _other)
{
...
void IndexBufferObject::ReferenceTo(const IndexBufferObject& _other, size _refOffset, size _refSize)
{
    nwAssertReturnVoid(!IsMapped(), "Buffer must be not mapped");
...
void IndexBufferObject::Update(const void* _data, size _size, size _offset /*= 0*/) const
{
...
void* IndexBufferObject::MapBuffer(EBufferMappingType _mapType, size _offset)
{
